document.addEventListener("DOMContentLoaded", () => {
  ...
  const columnslink = document.querySelectorAll(
    ".header-top .header-column a, .header-top .header-column button",
  );
  ...
  if (plusminuses.length) {
    plusminuses.forEach((plusminus) => {
      const input = plusminus.querySelector("input");
      const minusBtn = plusminus.querySelector("[data-minus]");
      const plusBtn = plusminus.querySelector("[data-plus]");
      ...
      // Define this BEFORE updateValue so it's available
